---
name: codemap
description: 为陌生或大型代码仓库生成层级化代码地图。当需要快速了解项目结构、梳理代码架构、生成代码文档、新人 onboarding、接手旧项目、分析开源库、理解陌生 repo、查看项目目录结构、模块依赖关系、代码全景图时使用。
---
...
关键词命中即触发：代码地图/项目结构/架构/模块依赖/新人onboarding/接手/快速了解/代码全景/目录结构。
