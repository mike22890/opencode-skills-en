...
description: 多 agent 对抗审查与高置信度验证。当需要多 agent 协作审查、交叉验证、对抗性测试、代码安全审计、漏洞狩猎、红队/蓝队演练、高置信度结论获取、复杂系统验证、多方评审、自动化 QA 流程时使用。
...
关键词命中即触发：多agent/对抗/交叉验证/红蓝/对抗测试/多方/审查/高置信度。
