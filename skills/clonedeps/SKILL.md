---
name: clonedeps
description: 将项目依赖的第三方库源码克隆到本地，便于深入阅读和调试。当需要查看库的实现细节、阅读源码、调试第三方依赖、理解 SDK/framework 内部机制、查看 node_modules 之外的原始代码、分析开源库架构、学习他人代码、查看依赖的 TypeScript 类型定义时使用。
---
...
关键词命中即触发：克隆依赖/源码/第三方库/阅读源码/调试依赖/底层实现/为什么报错/内部机制。
