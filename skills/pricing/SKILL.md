---
name: pricing
description: 产品定价策略与商业化设计。当需要定价分析、套餐设计、免费增值（Freemium）模式、价格锚定、A/B 测试定价、SaaS 定价、订阅制定价、一次性付费 vs 订阅、市场调研定价、竞品价格分析、价格心理学、变现策略时使用。
metadata:
  version: 2.1.1
---
...
关键词命中即触发：定价、套餐、订阅、免费增值、价格锚定、SaaS定价、变现、收费、多少钱。
...
| 用户说 | 加载 |
|---|---|
| 定价模型/收费方式/订阅/一次性/按量/按用户/混合/免费增值 | `references/pricing-models.md` |
| 套餐设计/层级/Good-Better-Best/差异化/功能分级/定价策略 | `references/tier-structure.md` |
| 定价调研/Van Westendorp/MaxDiff/支付意愿/市场调研/竞品价格 | `references/research-methods.md` |
| 定价页/页面审计/价格展示/透明度/AI可读性/结构化数据 | `references/pricing-page-teardown.md` |
