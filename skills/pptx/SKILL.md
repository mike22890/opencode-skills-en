---
name: pptx
description: PowerPoint 演示文稿的创建与编辑。当需要制作 PPT、幻灯片、演示文稿、Pitch deck、汇报材料、培训课件、keynote、演讲辅助、动态演示、PPT 模板设计、图表可视化、演示动画、导出 PDF/图片时使用。
...
关键词命中即触发：PPT/幻灯片/演示文稿/Pitch/汇报/培训/演讲/动态演示/模板/图表/导出。
