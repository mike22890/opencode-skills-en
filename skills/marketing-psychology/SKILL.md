...
description: 营销中的心理学原理与应用。当需要运用心理学做营销、用户决策分析、影响力法则（互惠/稀缺/权威/一致/喜好/共识）、锚定效应、损失厌恶、社会证明、FOMO 设计、定价心理学、消费行为分析、用户心理模型、说服架构设计时使用。
metadata:
  version: 2.0.0
---
...
关键词命中即触发：影响力、心理学、消费行为、说服、定价心理、FOMO、锚定、损失厌恶、社会证明、用户心理。
...
| 用户说 | 加载 |
|---|---|
| 影响力法则/Cialdini/互惠/稀缺/权威/说服技巧/引导/改变态度 | `references/influence.md` |
| 锚定/损失厌恶/框架效应/心理账户/定价心理学/消费决策 | `references/pricing-psychology.md` |
| 社会证明/FOMO/从众效应/稀缺性/紧迫感/信任建立 | `references/social-proof.md` |
| 用户心理/认知偏差/决策陷阱/思维误区/非理性 | `references/biases.md` |
